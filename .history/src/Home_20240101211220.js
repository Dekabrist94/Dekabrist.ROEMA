...
`;
const StyledImageBottom = styled.img`position: absolute;
width: 50%;
height: auto;
bottom: 0;
right: 0;
transform: translateY(50%);
animation: fadeInUpBottom 1s ease-out;
opacity: 0;
...
const StyledContainerBlock = styled(Container)`
  position: relative;
  overflow: hidden;
...
export const Home = () => {
  return (
    <>
      ...
      <StyledContainerBlock fluid className="text-white py-2">
        <h1
          style={{
        ...
        <StyledImageTop src={doosan} alt="Doosan" />

        <StyledImageBottom src={biglia} alt="Biglia" />
