          ...
          <Col>
            <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  "Lavoriamo costantemente con la mentalità di migliorarci ogni volta. Ogni
                  esperienza ci offre nuove opportunità di apprendimento. Per noi, l'innovazione è
          ...
          <Col>
            <Card style={{ width: '18rem' }}>
              ...
              <Card.Body>
                ...
                <Card.Text>
                  dsds\dasdasdasdsdas da sdasdasd asd asd asdas
                  dfdsfhdsfhsdgfhdsajfhdsjkafhdasjlkflkask
                </Card.Text>
                <Button variant="primary">Scopri di Piu</Button>
              </Card.Body>
            </Card>
