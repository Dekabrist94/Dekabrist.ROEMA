...
const StyledImageTop = styled.img`
  ...
  @media (max-width: 768px) {
    width: 100%; // изменить ширину на 100% на более узких устройствах
    margin-top: 3rem; // или другое значение по вашему выбору
  }
`;
...
const StyledImageBottom = styled.img`
  ...
  @media (max-width: 768px) {
    width: 100%; // изменить ширину на 100% на более узких устройствах
    margin-top: -8rem; // или другое значение по вашему выбору
  }
`;
  ...
  return (
    <>
      ...
      <Container
        ...
        <Row>
          <Col md={6}>
            <StyledImageBottom ref={topImageRef} src={doosan} alt="Doosan" />
          </Col>
          <Col md={6} style={{ paddingTop: '2rem' }}>
            <StyledImageTop ref={bottomImageRef} src={biglia} alt="Biglia" />
          </Col>
        </Row>
      </Container>
