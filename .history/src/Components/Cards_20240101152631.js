...
const Cards = () => {
  const textData = {
    ...
    stabilita: {
      ...
      text: "La nostra stabilità è la roccia su cui costruiamo il nostro cammino verso l'eccellenza, resistendo alle sfide . In ogni momento,siamo saldi nel nostro impegno,sostenendo la forza di un progresso duraturo e ispiratore.",
    },
  };
    ...
    <StyledCardsContainer>
      <Row xs={1} md={1} lg={3} xl={4}>
        {Object.keys(textData).map((key, index) => (
          <Col key={key} style={{ margin: '3.5rem' }}>
