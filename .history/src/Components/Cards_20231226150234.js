        ...
        <Card style={{ width: '18rem' }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              misurazione accurata dei componenti è alla base della fiducia dei nostri clienti. Per
              noi, i clienti sono il motore del nostro progresso continuo."
            </Card.Text>
        ...
        <Card style={{ width: '18rem' }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              ...
              costantemente. Ogni esperienza non solo ci offre nuove opportunità di apprendimento,
              ma anche il terreno fertile per l'evoluzione.
            </Card.Text>
            <Button variant="primary">Scopri di Piu</Button>
          </Card.Body>
        </Card>
