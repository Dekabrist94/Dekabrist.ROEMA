    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header
          ...
          <Modal.Title style={{ color: 'grey' }}>Ordinare</Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ background: 'linear-gradient(to left, black, darkRed )' }}>
          <Form>
            <Form.Group controlId="formBasicEmail" style={{ color: 'grey' }}>
              <Form.Label>E-mail:</Form.Label>
              <Form.Control type="email" placeholder="Enter E-mail" />
              <Form.Text className="text-muted"></Form.Text>
            </Form.Group>
            <Form.Group controlId="formPlace">
              <Form.Label style={{ color: 'grey' }}>Type Your Message:</Form.Label>
              <Form.Control type="email" placeholder="Enter Text" />
              <Form.Text className="text-muted"></Form.Text>
            </Form.Group>
            <Form.Group controlId="formBasicCheckbox" style={{ color: 'grey' }}>
              <Form.Check
                type="checkbox"
