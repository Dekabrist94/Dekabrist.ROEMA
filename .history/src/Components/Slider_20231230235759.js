...
export default function Slider() {
  return (
    <StyledCarousel>
      ...
      <Carousel.Item style={{ height: '45vh' }}>
        <img className="d-block w-100 h-100" src={img4} alt="Four Slide" />
        <Carousel.Caption>
          <h3>Four Slide</h3>
      ...
      <Carousel.Item style={{ height: '45vh' }}>
        <img className="d-block w-100 h-100" src={img5} alt="Fiveth Slide" />
        <Carousel.Caption>
          <h3>Fiveth Slide</h3>
      ...
      <Carousel.Item style={{ height: '45vh' }}>
        <img className="d-block w-100 h-100" src={img6} alt="Sixth Slide" />
        <Carousel.Caption>
          <h3>Sixth Slide</h3>
