...
export default function Slider() {
  return (
    <StyledCarousel>
      ...
      <Carousel.Item style={{ height: '45vh' }}>
        <img className="d-block w-100 h-80" src={img2} alt="Second Slide" />
        <Carousel.Caption>
          <h3>Second Slide</h3>
      ...
      <Carousel.Item style={{ height: '45vh' }}>
        <img className="d-block w-100 h-80" src={img3} alt="Third Slide" />
        <Carousel.Caption>
          <h3>Third Slide</h3>
      ...
      <Carousel.Item style={{ height: '45vh' }}>
        <img className="d-block w-100 h-80" src={img4} alt="Four Slide" />
        <Carousel.Caption>
          <h3>Four Slide</h3>
      ...
      <Carousel.Item style={{ height: '45vh' }}>
        <img className="d-block w-100 h-80" src={img5} alt="Fiveth Slide" />
        <Carousel.Caption>
          <h3>Fiveth Slide</h3>
      ...
      <Carousel.Item style={{ height: '45vh' }}>
        <img className="d-block w-100 h-80" src={img6} alt="Sixth Slide" />
        <Carousel.Caption>
          <h3>Sixth Slide</h3>
