  ...
  return (
    <Container
      style={{
        ...
        alignItems: 'center',
        paddingLeft: '1rem', // Уменьшил отступы для адаптации
        paddingRight: '1rem', // Уменьшил отступы для адаптации
      }}>
      <Row xs={1} md={2} lg={3} style={{ gap: '1rem' }}>
        {Object.keys(textData).map((key) => (
          <Col key={key} style={{ marginBottom: '1rem' }}>
            <Card>
              <Card.Img
                variant="top"
