...
const fadeInUpBottom = keyframes`
  to {
    opacity: 1;
    transform: translateY(0);
  }
  ...
  return (
    <>
      ...
      <StyledBackgroundContainer fluid>
        className="text-white py-2" style=
        {{ background: 'linear-gradient(to right, red, black)', height: '90vh' }}>
        <h1
          style={{
        ...
        <StyledImage ref={topImageRef} src={doosan} alt="Doosan" />
