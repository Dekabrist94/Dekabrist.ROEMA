...
export const Home = () => {
  return (
    <>
      ...
      <Container style={{ paddingTop: '4rem', paddingBottom: '4rem' }}>
        <Row>
          <Col md={6} sm={12} style={{ order: 2, textAlign: 'center' }}>
            {/* Изменил размеры колонок и выравнивание для мобильных устройств */}
            <img
              src={azienda}
              height={400}
              width="100%"
          ...
          <Col md={6} sm={12} style={{ order: 1 }}>
            ...
            <ul style={{ listStyleType: 'circle', fontSize: '15px' }}>
      ...
      <Container
        ...
        <Row>
          ...
          <Col md={6} style={{ order: 1, textAlign: 'center' }}>
