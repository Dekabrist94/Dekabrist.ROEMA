        ...
        <Row>
          ...
          <Col md={6}>
            <div style={{ color: 'white', padding: '1rem', textAlign: 'center' }}>
              <h2 style={{ paddingTop: '8rem', fontWeight: 'bold' }}>
                OFFICINE RO.E.MA. MECCANICA DI PRECISIONE
              </h2>
              <p style={{ fontWeight: 'bold' }}>P. IVA: IT01772580336</p>
              <p style={{ fontWeight: 'bold' }}>Tel: +39 035.5682454</p>
