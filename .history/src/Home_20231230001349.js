        ...
        <Row>
          ...
          <Col md={6}>
            <div style={{ color: 'white', padding: '1rem', textAlign: 'center' }}>
              <h2 style={{ paddingTop: '8rem' }}>OFFICINE RO.E.MA. MECCANICA DI PRECISIONE</h2>
              <p>
                <bold>P. IVA: IT01772580336</bold>
              </p>
              <p>Tel: +39 035.5682454</p>
              <p>Sede operativa: via Ca’ Fittavoli, 20-21 – 24030 Barzana (BG) Italia</p>
            </div>
          </Col>
